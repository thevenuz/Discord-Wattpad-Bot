...
import aiohttp
from wattpad.meta.models.checkcustomchannels import AuthorCustomChannel, CheckCustomMsgAuthor
...
class AuthorUtil:
    ...
    async def build_check_custom_msgs_msg(self, records:List[CheckCustomMsgAuthor]) -> str:
        try:
