...
from wattpad.models.enum import HelpCategory

plugin = lightbulb.Plugin("HelpPlugin")

filePrefix = "wattpad.plugins.commands.help"
...
async def help(ctx: lightbulb.SlashContext):
    try:
        logger.info("%s.help method invoked for server: %s, category: %s", filePrefix, ctx.guild_id, ctx.options.category)
        ...
        if not category:
            ...
            embed= hikari.Embed(title=f"{msgs['help:title']}", description=f"{msgs['help:desc']}", color=0Xff500a)

            embed.add_field(name=f"{msgs['help:note:title']}", value=f"{msgs['help:note']}", inline=False)

            embed.add_field(name=f"**set-channel**", value=f"{msgs['help:set:channel']}", inline=True)
            ...
            embed.add_field(name=f"**follow-story**", value=f"{msgs['help:follow:story']}", inline=True)
            ...
            embed.add_field(name=f"**follow-author**", value=f"{msgs['help:follow:author']}", inline=True)
            ...
            embed.add_field(name=f"**set-custom-channel for-story**", value=f"{msgs['help:set:custom:channel:story']}", inline=True)
            ...
            embed.add_field(name=f"**set-custom-message for-story**", value=f"{msgs['help:set:custom:msg:story']}", inline=True)
            ...
            embed.add_field(name=f"**support server**", value=f"{msgs['support']}")

        elif category.lower() == HelpCategory.About.value:
            logger.info("About help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:about:title']}", description=f"{msgs['help:about']}", color=0Xff500a)

        elif category.lower() == HelpCategory.Setup.value:
            logger.info("Setup help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:setup:title']}", description=f"{msgs['help:setup']}", color=0Xff500a)

        elif category.lower() == HelpCategory.Channel.value:
            logger.info("Channel help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:channel:title']}", color=0Xff500a)
        ...
        elif category.lower() == HelpCategory.Story.value:
            logger.info("Story help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:story:title']}", color=0Xff500a)
        ...
        elif category.lower() == HelpCategory.Author.value:
            logger.info("Author help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:author:title']}", color=0Xff500a)
        ...
        elif category.lower() == HelpCategory.CustomChannel.value:
            logger.info("Custom channel help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:custom:channel:title']}", color=0Xff500a)
        ...
        elif category.lower() == HelpCategory.CustomMsg.value:
            logger.info("Custom message help command triggered")

            embed= hikari.Embed(title=f"{msgs['help:custom:msg:title']}", color=0Xff500a)
            ...
            embed.add_field(name=f"**unset-custom-message for-story**", value=f"{msgs['unset:custom:msg:story']}{msgs['unset:custom:msg:story:ex']}", inline=False)
        ...
        logger.fatal("Exception occured in %s.help method for server: %s", filePrefix, ctx.guild_id,exc_info=1)
        raise e
